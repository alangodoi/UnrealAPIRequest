...
/*Http call*/
void AHttpActor::MyHttpCall(FString Subroute) {
  TSharedRef<IHttpRequest> Request = Http->CreateRequest(); Request->OnProcessRequestComplete().BindUObject(this, &AHttpActor::OnResponseReceived);
  //This is the url on which to process the request
  Request->SetURL("https://api.crmsimples.com.br/API?method=getPainelGame" + Subroute);
  Request->SetVerb("GET");
